...
static const fa2_token_metadata_t FA2_TOKEN_REGISTRY[] = {
    ...
    {"Temple Key", "TKEY", 18,
     {0xE6, 0x41, 0x04, 0xE1, 0x3F, 0x4C, 0x13, 0x54, 0xF6, 0x78,
      0x15, 0xAA, 0x19, 0xE8, 0xC8, 0x28, 0x3C, 0x28, 0x1F, 0x94}},
    /* KT1M81KrJr6TxYLkZkVqcpSTNKGoya8XytWT */
    {"Ecoin Network", "ECN", 8,
     {0x89, 0x89, 0xE3, 0xFC, 0x67, 0x9C, 0x90, 0xA7, 0x94, 0xED,
      0xD6, 0x53, 0x70, 0xC3, 0x6C, 0xD9, 0x09, 0xF2, 0x35, 0x70}},
    /* KT193D4vozYnhGJQVtw7CoxxqphqUEEwK6Vb */
    {"Quipuswap Governance", "QUIPU", 6,
    ...
    {"Kalamint", "KALAM", 10,
     {0x10, 0x61, 0x67, 0xAC, 0xE0, 0x99, 0xE2, 0x33, 0xD3, 0x82,
      0xFC, 0x51, 0x36, 0xDE, 0x4A, 0x7F, 0xFE, 0xCA, 0x3F, 0x11}},
    /* KT1LcNFDj66TTXKFBjQLQwo9J7tENbrq8AJE */
    {"TZ Apex", "APEX", 1,
     {0x83, 0xEE, 0xDF, 0xFF, 0x1D, 0xC4, 0xF6, 0xC3, 0xA0, 0x28,
      0x10, 0x3B, 0x04, 0x7B, 0x29, 0x5D, 0xC1, 0x4D, 0xCD, 0x57}},
    /* KT1ShjB24tTXX8m5oDCrBHXqynCpmNJDxpD5 */
    {"TRASH", "TRASH", 8,
     {0xC6, 0xC3, 0x2D, 0xCF, 0xD9, 0x93, 0x07, 0x18, 0xDD, 0xD5,
      0x26, 0xDC, 0xAE, 0x2B, 0x05, 0x59, 0xE7, 0x02, 0xB5, 0xD1}},
    /* KT1C9X9s5rpVJGxwVuHEVBLYEdAQ1Qw8QDjH */
    {"TezDAO", "TezDAO", 6,
     {0x27, 0x1A, 0x12, 0xCF, 0xF3, 0x75, 0x51, 0x9B, 0x1D, 0xC2,
      0x41, 0x47, 0x59, 0x3F, 0x65, 0xD7, 0xEF, 0xA1, 0xA1, 0x57}},
    /* KT1Hc6KSHp3pLLiCXUkuHva62PRJQ8JmyAcP */
    {"mew", "mew", 6,
     {0x62, 0xF9, 0x33, 0xC3, 0x0D, 0xE8, 0x27, 0x14, 0x25, 0x12,
      0xF7, 0xD5, 0xA6, 0x92, 0xFD, 0x61, 0x8A, 0x6F, 0xCA, 0xBB}},
    /* KT1R4KPQxpFHAkX8MKCFmdoiqTaNSSpnJXPL */
    {"Tezos Domains Vote", "TEDv", 6,
     {0xB4, 0xB7, 0xCE, 0x89, 0x3D, 0x4B, 0xCD, 0xFD, 0xC2, 0xC6,
      0x31, 0x3D, 0xDA, 0xF4, 0xC9, 0xE7, 0xF1, 0x25, 0x87, 0x9D}},
    /* KT1AFA2mwNUMNd4SsujE1YYp29vd8BZejyKW */
    {"Hic et nunc DAO", "hDAO", 6,
     {0x12, 0x3A, 0xAF, 0x8D, 0x2C, 0x25, 0xE0, 0xDD, 0xAF, 0xA6,
      0xD9, 0x8E, 0x16, 0x58, 0x2D, 0xE7, 0x47, 0x8F, 0x09, 0x25}},
    /* KT1XnTn74bUtxHfDtBmm2bGZAQfhPbvKWR8o */
    {"Tether USD", "USDt", 6,
     {0xFE, 0x81, 0x09, 0x59, 0xC3, 0xD6, 0x12, 0x7A, 0x41, 0xCB,
      0xD4, 0x71, 0xE7, 0xCB, 0x4E, 0x91, 0xA6, 0x1B, 0x78, 0x0B}},
    /* KT18opRzxCFTyhU6iw2g3DUfBy82GRYXqHjH */
    {"OTTEZ", "OTTEZ", 8,
     {0x02, 0x77, 0xCC, 0xCD, 0xBB, 0x9F, 0x82, 0x7E, 0xED, 0x2D,
      0x14, 0x93, 0xD9, 0x15, 0x56, 0xB6, 0x5B, 0xB1, 0x71, 0xE5}},
    /* KT1BCzAq3PrTKPsEBKuoTGZdwX6rN6WE8rJj */
    {"Cerveza", "CVZA", 8,
     {0x1C, 0xC9, 0xBF, 0x78, 0xD8, 0x1A, 0xBE, 0x5D, 0x6E, 0x38,
      0x3A, 0x9B, 0x1B, 0xEE, 0x25, 0xD8, 0x7D, 0xAB, 0x25, 0xF6}},
    /* KT1HiHZVckhfApEmXFqCCRjWhS1dWAYQGbtm */
    {"Vendcoin", "VEND", 6,
     {0x64, 0x25, 0x15, 0x26, 0xB9, 0x69, 0x86, 0x77, 0xD9, 0x03,
      0x72, 0xCE, 0xF2, 0x45, 0x85, 0x46, 0x68, 0xEE, 0x32, 0xA3}},
    /* KT1QrtA753MSv8VGxkDrKKyJniG5JtuHHbtV */
    {"Teia DAO", "TEIA", 6,
     {0xB2, 0x8E, 0x2B, 0xB3, 0xC7, 0xF9, 0xBC, 0x8B, 0x49, 0x6F,
      0xE1, 0x6D, 0x80, 0xCB, 0xB8, 0x69, 0xF8, 0x22, 0xAF, 0xC6}},
    /* KT1UQVEDf4twF2eMbrCKQAxN7YYunTAiCTTm */
    {"Pole", "$POLE", 8,
     {0xD9, 0x70, 0xB7, 0xF6, 0xEA, 0xFA, 0xF9, 0xF8, 0x18, 0x0F,
      0x4E, 0xCE, 0x84, 0xC7, 0xCE, 0x2F, 0x98, 0x06, 0x89, 0xDB}},
    /* KT1Wa8yqRBpFCusJWgcQyjhRz7hUQAmFxW7j */
    {"FLAME", "FLAME", 6,
     {0xF1, 0x34, 0x3A, 0x45, 0xAE, 0x95, 0x91, 0xFC, 0xCB, 0x7A,
      0x2F, 0x9D, 0xAF, 0xB5, 0x87, 0xF8, 0xC3, 0x35, 0x3E, 0x4F}},
    /* KT1Xobej4mc6XgEjDoJoHtTKgbD1ELMvcQuL */
    {"youves YOU Governance", "YOU", 12,
     {0xFE, 0xB8, 0x06, 0x3B, 0x90, 0x18, 0xF8, 0x3C, 0x8E, 0xC5,
      0xF4, 0x64, 0x55, 0xE9, 0x36, 0x6D, 0x7B, 0xF4, 0xD2, 0xDA}},
    /* KT1Avad9GZXRSoKzUukD5qSen44WxPRGsQCN */
    {"Tezos Inu", "TEZINU", 6,
     {0x19, 0xAF, 0x6F, 0xE4, 0xA7, 0xB1, 0xC8, 0xBB, 0xAC, 0xE5,
      0x4F, 0x87, 0x66, 0x08, 0x53, 0x9D, 0x95, 0x62, 0x93, 0x35}},
    /* KT1MZg99PxMDEENwB4Fi64xkqAVh5d1rv8Z9 */
    {"Tezos Pepe", "PEPE", 2,
     {0x8E, 0x64, 0xB0, 0xEB, 0xE6, 0x15, 0x8C, 0x5F, 0x6B, 0xD1,
      0x8C, 0x6C, 0x6B, 0x1B, 0xC1, 0x7B, 0x57, 0x50, 0xD6, 0x07}},
    /* KT1BYfAK4j2aYSBNoxtbrCdKezNV6NTSdeSB */
    {"rugged", "RUGD", 2,
     {0x20, 0x82, 0x33, 0x07, 0x86, 0x17, 0xC5, 0xA0, 0xF8, 0x60,
      0xD4, 0x6D, 0x2F, 0xEC, 0x81, 0x30, 0x8B, 0xDB, 0xF0, 0x71}},
    /* KT1WapdVeFqhCfqwdHWwTzSTX7yXoHgiPRPU */
    {"TezID", "IDZ", 8,
     {0xF1, 0x55, 0x53, 0x3F, 0xA1, 0xB0, 0x22, 0x96, 0xAE, 0x18,
      0xCB, 0x0A, 0x2C, 0x67, 0x38, 0xA0, 0x89, 0x6F, 0xDE, 0x2C}},
    /* KT1JBERhXmBgzBAfN27LSBbuJdXfn12vYrrF */
    {"GeckoCoin", "GECKO", 2,
     {0x69, 0x3D, 0xB2, 0x77, 0x5E, 0x28, 0xAF, 0x83, 0xAF, 0xC0,
      0xBE, 0x4C, 0x10, 0x7E, 0xF6, 0xEE, 0x31, 0xF5, 0x03, 0x6A}},
    /* KT1ErKVqEhG9jxXgUG2KGLW3bNM7zXHX8SDF */
    {"Unobtanium", "UNO", 9,
     {0x44, 0xC1, 0xA6, 0x57, 0xFC, 0x0A, 0xEB, 0xB8, 0x00, 0xAA,
      0xA2, 0x94, 0x17, 0xBF, 0x61, 0x9D, 0x4A, 0xBF, 0x77, 0xB5}},
    /* KT18hYjnko76SBVv6TaCT4kU6B32mJk6JWLZ */
    {"MathMakesArt", "MATH", 6,
     {0x01, 0x48, 0x34, 0x43, 0x55, 0x49, 0x52, 0x58, 0x3D, 0xA0,
      0xCC, 0x0A, 0x69, 0x9E, 0x2F, 0x55, 0xFA, 0x82, 0x0B, 0xAE}},
    /* KT1Vfc3EMLzHdZapxxyC9zForN3Qas9TEed7 */
    {"clint", "$clint", 6,
     {0xE7, 0x44, 0xC4, 0xDC, 0x21, 0x64, 0x0E, 0xFE, 0x8D, 0x2F,
      0xAE, 0x24, 0x11, 0x72, 0x3D, 0x5E, 0x55, 0x2E, 0xCF, 0xE5}},
    /* KT1JXxK3bd39ayLiiBdKm2cdReYnVSG3bkzK */
    {"Hera Network", "HERA", 3,
     {0x6D, 0x28, 0xFA, 0xFD, 0xE8, 0xB3, 0xC7, 0xBA, 0xBE, 0x04,
      0xB7, 0x16, 0x58, 0xF2, 0x01, 0xFD, 0x80, 0xE5, 0xCA, 0x14}},
    /* KT1XPFjZqCULSnqfKaaYy8hJjeY63UNSGwXg */
    {"Crunchy DAO", "crDAO", 8,
     {0xFA, 0x1D, 0x6A, 0x70, 0x36, 0x14, 0x39, 0xBC, 0x3E, 0xCA,
      0x1B, 0xCF, 0x91, 0xE0, 0xAC, 0x57, 0xFA, 0xD6, 0x67, 0xC0}},
    /* KT1Cjx8hYwzaCAke6rLWoZBLp8w89VeAduAR */
    {"Taco DAO", "tDAO", 4,
     {0x2D, 0x9D, 0x11, 0x81, 0x30, 0xB4, 0x29, 0xA4, 0x90, 0x8B,
      0x5C, 0x01, 0x4E, 0xB7, 0x80, 0x36, 0x72, 0xF1, 0x90, 0x65}},
    /* KT1F1mn2jbqQCJcsNgYKVAQjvenecNMY2oPK */
    {"Pixel", "PXL", 6,
     {0x46, 0x8B, 0x54, 0x8C, 0xDE, 0x1C, 0xC8, 0xC8, 0x03, 0x66,
      0xE2, 0x8F, 0x8F, 0x44, 0xE5, 0x7B, 0xA4, 0xDD, 0xC3, 0xCC}},
    /* KT1C96evxB1mkEszQczc9ki3je4kSQBhR1et */
    {"Zenith", "ZNT", 5,
     {0x27, 0x05, 0x9F, 0x74, 0xBF, 0xE5, 0xEF, 0x88, 0xD6, 0xB9,
      0x29, 0x89, 0x68, 0xFA, 0x52, 0xE1, 0x18, 0x35, 0x52, 0xB7}},
    /* KT1981tPmXh4KrUQKZpQKb55kREX7QGJcF3E */
    {"Sebuh.net", "SEB", 2,
     {0x05, 0xE8, 0xD9, 0x7A, 0xA3, 0x69, 0x10, 0xA8, 0xDC, 0x5C,
      0x02, 0x6F, 0x94, 0x09, 0xAA, 0x4D, 0x1C, 0xFA, 0xF6, 0x4C}},
    /* KT1RTsRfBxLf6egtsXrQX1CcXCqKL3XwpuFT */
    {"DoctaGonz", "GONZ", 6,
     {0xB9, 0x2C, 0x1E, 0x54, 0x37, 0x55, 0x4D, 0x99, 0x97, 0x08,
      0x19, 0xD1, 0x52, 0x8F, 0x61, 0x77, 0x35, 0x40, 0x2F, 0xF0}},
    /* KT1Fzw3uNEM7Ez8tysopUGwzDsoU2YZKUYuA */
    {"DEEPLOY", "DEEP", 5,
     {0x51, 0x5A, 0xC8, 0x07, 0xB7, 0x34, 0xE8, 0x91, 0xFF, 0x77,
      0x69, 0x3D, 0x2E, 0x36, 0x5E, 0x4B, 0x12, 0x12, 0xE3, 0x1B}},
    /* KT1SZ4ABJ6zER1sJpg11GNVKWXSno1CAK5GM */
    {"Hitchens", "HITCH", 18,
     {0xC5, 0x1F, 0x48, 0x99, 0xB5, 0xB1, 0x47, 0xD7, 0x87, 0x51,
      0x37, 0xED, 0xC8, 0x53, 0xA8, 0xF6, 0x00, 0x43, 0x9C, 0xA3}},
    /* KT1XTxpQvo7oRCqp85LikEZgAZ22uDxhbWJv */
    {"GIF DAO", "GIF", 9,
     {0xFB, 0x01, 0x5F, 0xDC, 0x02, 0xAA, 0xE8, 0xEE, 0x28, 0xD9,
      0x16, 0xE8, 0xF6, 0x36, 0x3A, 0x34, 0x3B, 0xE0, 0x2B, 0xBE}},
    /* KT1HZFZiJxexeBU9Lfp5GrM3yZLq7LPHgtVt */
    {"KORA Asset", "KORA", 2,
     {0x62, 0x6F, 0xAC, 0x2F, 0x81, 0x17, 0xA4, 0xF5, 0x24, 0x06,
      0x9F, 0x48, 0xC7, 0x2F, 0xBC, 0x9C, 0x0A, 0x54, 0x2D, 0x72}},
    /* KT1TxyzQh7AqVHjjnPAAakuBwiCaWvVLp2pT */
    {"Tacos", "TACOS", 2,
     {0xD4, 0x9D, 0xE9, 0xAF, 0x47, 0x92, 0x19, 0xC7, 0x73, 0x7A,
      0xC6, 0x7C, 0x07, 0x57, 0xF6, 0x97, 0x69, 0xCC, 0xFD, 0xB4}},
    /* KT1QoDjTpkG9jmAMwrPCsaRR78xHDcRKydBp */
    {"tChicken", "tChicken", 6,
     {0xB1, 0xDC, 0xD8, 0xEC, 0xE0, 0xF6, 0x1C, 0x9A, 0x75, 0x7D,
      0x06, 0xC3, 0xB3, 0xF8, 0x91, 0x23, 0x4D, 0x7E, 0xDC, 0xC8}},
};
