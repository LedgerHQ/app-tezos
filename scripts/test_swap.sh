...
usage() {
    echo "Usage: ./scripts/test_swap.sh {build_app_tezos|build_app_ethereum|build_app_exchange|run_tests|run_tests_all|update} {nanos|nanosp|nanox|stax|flex|apex_p}"
}
...
devices=("nanos" "nanosp" "nanox" "stax" "flex" "apex_p")
