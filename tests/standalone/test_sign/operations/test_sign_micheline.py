...
# Some prim cases use -data / -instr / -type suffixes on their pytest ids so snapshot
# paths stay unique on case-insensitive filesystems (e.g. macOS). If a device directory
# under snapshots/ is missing PNGs for a parametrized case, run tests with --golden-run
# for that device to refresh goldens.
prim_cases: List[Tuple[Micheline, str]] = [
    ...
    ({"prim": "LSR"}, "LSR"),
    ({"prim": "LT"}, "LT"),
    ({"prim": "MAP", 'args': [[{"prim": "UNIT"}]]}, "MAP-instr"),
    ({"prim": "MEM"}, "MEM"),
    ({"prim": "MUL"}, "MUL"),
    ({"prim": "NEG"}, "NEG"),
    ({"prim": "NEQ"}, "NEQ"),
    ({"prim": "NIL", 'args': [{"prim": "unit"}]}, "NIL"),
    ({"prim": "NONE", 'args': [{"prim": "unit"}]}, "NONE-instr"),
    ({"prim": "NOT"}, "NOT"),
    ({"prim": "NOW"}, "NOW"),
    ({"prim": "MIN_BLOCK_TIME"}, "MIN_BLOCK_TIME"),
    ({"prim": "OR"}, "OR-instr"),
    ({"prim": "PAIR", 'args': [{"int": 0x3FF}]}, "PAIR-instr"),
    ...
    ({"prim": "RIGHT", 'args': [{"prim": "unit"}]}, "RIGHT-instr"),
    ({"prim": "SIZE"}, "SIZE"),
    ({"prim": "SOME"}, "SOME-instr"),
    ({"prim": "SOURCE"}, "SOURCE"),
    ({"prim": "SENDER"}, "SENDER"),
    ({"prim": "SELF"}, "SELF"),
    ...
    ({"prim": "ADDRESS"}, "ADDRESS-instr"),
    ({"prim": "CONTRACT", 'args': [{"prim": "unit"}]}, "CONTRACT-instr"),
    ({"prim": "ISNAT"}, "ISNAT"),
    ...
    # Type
    ({"prim": "bool"}, "bool"),
    ({"prim": "contract", 'args': [{"prim": "unit"}]}, "contract-type"),
    ({"prim": "int"}, "int-type"),
    ({"prim": "key"}, "key"),
    ({"prim": "key_hash"}, "key_hash"),
    ({"prim": "lambda", 'args': [{"prim": "unit"}, {"prim": "unit"}]}, "lambda-type"),
    ({"prim": "list", 'args': [{"prim": "unit"}]}, "list"),
    ({"prim": "map", 'args': [{"prim": "unit"}, {"prim": "unit"}]}, "map-type"),
    ...
    ({"prim": "ticket", 'args': [{"prim": "unit"}]}, "ticket-type"),
